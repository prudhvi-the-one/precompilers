  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <div>
          <label className="mb-1 block text-xs font-medium text-ink-secondary">Track name</label>
          <input
            required
            value={name}
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-ink-secondary">Required plan</label>
          <select
      ...
      <div>
        <label className="mb-1 block text-xs font-medium text-ink-secondary">Relevant roles</label>
        <div className="flex flex-wrap gap-2">
          {ROLES.map((role) => (
            <label
              key={role.value}
              className="flex items-center gap-1.5 rounded-md border border-line px-2.5 py-1.5 text-xs"
            >
              <input
                type="checkbox"
