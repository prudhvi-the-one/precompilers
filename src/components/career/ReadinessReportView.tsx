        ...
        <div className="flex flex-col items-start gap-5 sm:flex-row">
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {delta !== null ? (
                <span className="clip-chip bg-success-soft px-2.5 py-1 text-xs font-semibold text-success">
                  {delta >= 0 ? "+" : ""}
                  {delta} in 90 days
                </span>
              ) : null}
              <span className="clip-chip bg-line-soft px-2.5 py-1 text-xs font-medium text-ink-secondary">
                {activityLine}
              </span>
            </div>
          </div>
          ...
          <div className="mt-3 space-y-2">
            {recommendations.map((rec) => (
              <AngularBorder
                key={rec.action}
                color="var(--line-soft)"
                className="flex items-center justify-between gap-4 bg-surface px-3.5 py-2.5"
              >
                <div className="flex items-center gap-3">
                  <span className="clip-chip shrink-0 bg-accent-soft px-2 py-1 font-mono text-xs font-semibold text-accent">
                    +{rec.pointDelta}
                  </span>
